...
/**
 * JwtAuthenticationToken 을 감싸는 프록시 클래스. JwtAuthenticationToken 에 TripAmiAuthentication 인터페이스를 추가함.
 */
public class TripAmiJwtAuthenticationToken extends JwtAuthenticationToken implements TripAmiAuthentication {
    private final Long memberId;
    private final Long authMemberId;
    private final String username;
    private final JwtAuthenticationToken target;

    public TripAmiJwtAuthenticationToken(JwtAuthenticationToken target) {
